...
<link rel="stylesheet" type="text/css" href="/fridgeCare/css/my.css">
<script type="text/javascript" src="/fridgeCare/js/jquery.min.js"></script>
<!--
<script type="text/javascript" src="/fridgeCare/js/"></script>
-->
<style>
        	...
        	<form action="/recipes" accept-charset="UTF-8" method="get">
        		...
        		<div id="ckbox" style="border: 0px solid;">
					<div class="field1" style="margin: 10px; vertical-align: middle; border: 1px solid; text-align: justify; text-align: center;">
						...
						<button style=""><img src="/fridgeCare/img/cook/search.png"></button>
	        		</div>
						...
						<ul style="padding-inline-start: 0px;">
							<li style="margin-left: 0px;">
								<a ingre_id="71" href="javascript:;">
								 	<em></em>
								 	<img src="/fridgeCare/img/cook/bread.png" alt="bread" />
								 	<strong>빵</strong>
								</a>
							</li>
							<li style="margin-left: 0px;">
								<a ingre_id="72" href="javascript:;">
								 	<em></em>
								 	<img src="/fridgeCare/img/cook/apple.png" alt="apple" />
								 	<strong>사과</strong>
								</a>
								</li>
							<li style="margin-left: 0px;">
								<a ingre_id="73" href="javascript:;">
								 	<em></em>
								 	<img src="/fridgeCare/img/cook/chicken.png" alt="chicken" />
								 	<strong>닭</strong>
								</a>
							</li>
							<li style="margin-left: 0px;">
								<a ingre_id="74" href="javascript:;">
								 	<em></em>
								 	<img src="/fridgeCare/img/cook/meat.png" alt="meat" />
								 	<strong>고기</strong>
								</a>
							</li>
							<li style="margin-left: 0px;">
								<a ingre_id="75" href="javascript:;">
								 	<em></em>
								 	<img src="/fridgeCare/img/cook/noodle.png" alt="noodle" />
								 	<strong>라면</strong>
								</a>
							</li>
						</ul>
